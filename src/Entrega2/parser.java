...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Thu Apr 18 10:13:36 PDT 2013
  */
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		RESULT= new Exp_SimpStringAST(s);
		...
		RESULT= new Exp_SimpNewIdAST(id1,e);
		...
		RESULT= new DistiExpListAST(id1,el);
		...
		RESULT= new ThisIdIdAST(id1);   ////////////////////////Estosssssssssssssssssssssssssssssssss
		...
		RESULT= new StatCuadExpAST(id1,ce,ed);
		...
		RESULT= new StatExpListAST(id1,t,el);
		...
		RESULT= new VarTypeIdAST(id1,id2,fls);
		...
		RESULT= new FormalListAST(id1,id2,fls);
		...
		RESULT= new MethodDeclAST(id1,iv,fl,vd,s,r);
		...
		RESULT= new ConstrDeclAST(id1,fl,vd,s);
		...
		RESULT= new MainClassAST(id1,id2,s);  //t,i2,s);
		...
		RESULT= new TypeName2AST(id1,tns);
		...
		RESULT= new ClassDecl3AST(id1,cd3);
		...
		RESULT= new ClassDecl2AST(id1,cd2);
